...
static bool bif_bb_b_put_2(query *q)
{
    ...
    if (DO_DUMP)
        DUMP_TERM2("bb_b_put", tmpbuf, p2, p2_ctx, 1);
...
static bool bif_bb_put_2(query *q)
{
    ...
    if (DO_DUMP)
        DUMP_TERM2("bb_put", tmpbuf2, p2, p2_ctx, 1);
...
static bool bif_bb_get_2(query *q)
{
    ...
    if (DO_DUMP)
        DUMP_TERM2("bb_get", tmpbuf, tmp, q->st.cur_ctx, 1);
...
static bool bif_bb_delete_2(query *q)
{
    ...
    if (DO_DUMP)
        DUMP_TERM2("bb_delete", tmpbuf, tmp, q->st.cur_ctx, 1);
...
static bool bif_bb_update_3(query *q)
{
    ...
    if (DO_DUMP)
        DUMP_TERM2("bb_update", tmpbuf, p2, p2_ctx, 1);

...
static char *functor_name_generator(const char *text, int state)
{
    ...
    if (!state) {
        s_atts_list_index = 0;
        s_atts_len = strlen(text);
        s_bboard_list_index = 0;
        s_bboard_len = strlen(text);
        s_control_list_index = 0;
        s_control_len = strlen(text);
        s_csv_list_index = 0;
        s_csv_len = strlen(text);
        s_database_list_index = 0;
        s_database_len = strlen(text);
        s_evaluable_list_index = 0;
        s_evaluable_len = strlen(text);
        s_ffi_list_index = 0;
        s_ffi_len = strlen(text);
        s_files_list_index = 0;
        s_files_len = strlen(text);
        s_format_list_index = 0;
        s_format_len = strlen(text);
        s_iso_list_index = 0;
        s_iso_len = strlen(text);
        s_other_list_index = 0;
        s_other_len = strlen(text);
        s_os_list_index = 0;
        s_os_len = strlen(text);
        s_posix_list_index = 0;
        s_posix_len = strlen(text);
        s_maps_list_index = 0;
        s_maps_len = strlen(text);
        s_sort_list_index = 0;
        s_sort_len = strlen(text);
        s_streams_list_index = 0;
        s_streams_len = strlen(text);
        s_sregex_list_index = 0;
        s_sregex_len = strlen(text);
        s_tasks_list_index = 0;
        s_tasks_len = strlen(text);
        s_threads_list_index = 0;
        s_threads_len = strlen(text);
    }

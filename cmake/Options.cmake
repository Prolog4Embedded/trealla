...
option(TPL_USE_COMPAT_STUB_HEADERS
       "Use compat stub headers to more easily find os dependencies" OFF)

option(TPL_USE_EDITLINE "Use editline" OFF)
option(TPL_USE_READLINE
       "Use readline (default on non-WASI if no other editor is selected)" OFF)
...
set(TPL_EXTRA_CFLAGS
    ""
    CACHE STRING "Extra C compiler flags (like Makefile OPT)")
...
set(MAIN_PL
    ""
    CACHE FILEPATH "Path to main.pl used by compile_main target")
